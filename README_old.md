...
**Note:** This add-on requires [Blender 2.80](https://builder.blender.org/download/) or above. There is an older release compatible with Blender 2.79 available [here](https://github.com/andyp123/blender_vertex_color_master/releases/tag/v0.75).
...
**Note**: This feature is currently only available when a channel has been isolated.
