...
classes = (
    ...
    vcm_ops.VERTEXCOLORMASTER_OT_ColorBalance,
    vcm_ops.VERTEXCOLORMASTER_OT_Exposure,
    vcm_ops.VERTEXCOLORMASTER_OT_Contrast,
    vcm_ops.VERTEXCOLORMASTER_OT_Vibrance,
    vcm_ops.VERTEXCOLORMASTER_OT_Levels,
    vcm_ops.VERTEXCOLORMASTER_OT_LiveFill,
